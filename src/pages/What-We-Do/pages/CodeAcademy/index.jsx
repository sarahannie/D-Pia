...
export default function CodeAcademy() {
  ...
  return (
    <section>
      ...
      <section className='bg-[#F5FBFF] text-[#0B4A6F] py-10 lg:py-20 xl:px-40 px-4 lg:px-20'>
        <div className='flex flex-col space-y-16 '>
          <>
            <div className=''>
              <div className='flex  justify-center'>
                <h2 className='xl:w-2/4 text-2xl lg:text-4xl font-bold text-left'>
                  Code2Earn: Unlocking Potential for Adolescents and Young
                  Adults
                </h2>
              </div>
              <div className='flex flex-col items-center mt-5 xl:flex-row'>
                <div className='lg:w-1/2 space-y-8'>
                  ...
                  <div>
                    ...
                    <p className='lg:w-1/2 mt-3 ml-5 lg:text-lg lg:font-semibold'>
                  ...
                  <div>
                    ...
                    <ul className='mt-3 ml-8 space-y-2 text-md lg:text-lg lg:font-semibold list-disc '>
                ...
                <div className='lg:w-1/3 mt-2 lg:mt-0'>
                  <img
                    ...
                    className='w-full shadow-b-md h-96'
                  />
                </div>
              </div>
            </div>
          ...
          <>
            <div className='mt-16 '>
              ...
              <div className='flex flex-col items-center justify-between px-4 py-2 mt-5 md:flex-row'>
                <div className='lg:w-1/2 '>
                  <img
                    src={Code_To_Ace}
                    alt='code 2 ace image'
                    className='object-contain w-full shadow-b-md h-96'
                  />
                </div>
                <div className='lg:w-3/5 space-y-8'>
                  <div>
                    <p className='lg:w-2/3 mt-3 lg:ml-5 lg:text-lg lg:font-semibold'>
                  ...
                  <div className='lg:ml-5'>
                    ...
                    <div>
                      <ul className='mt-3 ml-8 space-y-2 lg:text-lg lg:font-semibold list-disc '>
                        <li className='ml-5 '>
      ...
      <section className='px-4 py-20 md:px-40 text-[#0B4A6F] bg-gray-50/80'>
        <div className='flex flex-col gap-8 text-left'>
          <h1 className='w-full text-lg lg:text-3xl font-bold lg:w-3/5 md:text-5xl'>
            <span className='block w-full'>
              Why Choose D-Pia Coding Academy?
            </span>
          </h1>
          <div>
            <ul className='lg:w-3/5 space-y-4'>
              <li className='flex items-center gap-4 lg:text-xl font-semibold'>
                <span>
        ...
        <div className='bg-[#001F6B] text-white py-10 lg:py-20 flex-col flex items-center justify-between px-4 lg:px-16 w-full rounded-3xl mt-28'>
          <div>
